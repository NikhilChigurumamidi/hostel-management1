...
insert  into `book`(`host`,`hname`,`type`,`food`,`price`,`location`,`guest`,`status`) values ('chotu','mummy','Girls','Nonveg','3000','ameerpet','moulali','accepted');
...
insert  into `hostel`(`username`,`hname`,`type`,`food`,`price`,`location`) values ('chotu','mummy','Girls','Nonveg','3000','ameerpet');
